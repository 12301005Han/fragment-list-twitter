...
public class MainActivity extends Activity implements MyListFragment.OnFragmentInteractionListener
{
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      myListFragment =new MyListFragment();
       ...
       getFragmentManager().beginTransaction().add(R.id.fragment_holder,myListFragment).commit();
   } // end method onCreate
   ...
   private void addTaggedSearch(String query, String tag)
   {
    ...
    public void openSearch(String tag){
        ...
        getFragmentManager().beginTransaction().replace(R.id.fragment_holder,WebFragment.newInstance(urlString)).addToBackStack(null).commit();
